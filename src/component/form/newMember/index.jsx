...
const MemberRegistrationForm = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      formData.append(
        "medical_conditions",
        JSON.stringify(values.medical_conditions || [])
      );
    ...
    <div style={{ width: "100%", overflow: "hidden", padding: "20px" }}>
      ...
      >
        <h2 style={{ margin: 0, fontSize: "24px" }}>
          <UserOutlined style={{ marginRight: "12px", color: "#1890ff" }} /> New
          Member Registration
        </h2>
      ...
      >
        ...
        <Row gutter={16}>
          ...
          <Col xs={24} sm={12} md={8}>
            ...
            >
              ...
              >
                <Button icon={<IdcardOutlined />} size="large">
                  Upload ID Proof
                </Button>
              </Upload>
            </Form.Item>
          ...
          <Col xs={24} sm={12} md={8}>
            ...
            >
              <Select placeholder="Select type" size="large">
                {plansData?.map((item) => {
                  return <Option value={item?.planId}>{item?.planName}</Option>;
                })}
              </Select>
            </Form.Item>
          </Col>
        ...
        <Form.Item name="injuries" label="Previous Injuries/Surgeries">
          <TextArea
            rows={2}
        ...
        <Form.Item name="fitness_goals" label="Fitness Goals">
          <TextArea
            rows={2}
